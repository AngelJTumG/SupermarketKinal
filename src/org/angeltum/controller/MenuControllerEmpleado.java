 ...
 * @author Angel
 */
public class MenuControllerEmpleado implements Initializable{
    ...
    public CargoEmpleado buscarCodigoCargoEmpleado(int codigoCargoEmpleado) {
        ...
        try {
            ...
            while (registro.next()) {
                resultado = new CargoEmpleado(registro.getInt("codigoCargoEmpleado"), registro.getString("nombreCargo"), registro.getString("descripcionCargo"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
